...
int main() {
    ...
    cout << "—ложность алгоритма: " << complexity << endl;
    cout << "ѕроизводительность первого варианта: " << performanceFirstVariant << " MFlops" << endl;
    cout << "ѕроизводительность второго варианта: " << performanceSecondVariant << " MFlops" << endl;
    cout << "ѕроизводительность третьего варианта: " << performanceThirdVariant << " MFlops" << endl;
 
    if (performanceThirdVariant >= 0.3 * performanceSecondVariant) {
        cout << "“ретий вариант удовлетвор€ет условию производительности." << endl;
    }
    else {
        cout << "“ретий вариант не удовлетвор€ет условию производительности." << endl;
    }
